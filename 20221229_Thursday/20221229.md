...
# = = = = = = = = = = = = = =
# Runtime: 1858 ms, faster than 99.84% of Python3 online submissions for Single-Threaded CPU.
# Memory Usage: 63.7 MB, less than 5.09% of Python3 online submissions for Single-Threaded CPU.Python
# https://leetcode.com/problems/single-threaded-cpu/solution/
class Solution:
