...
Create adjacency list based on similar method. Important to exit from the
similar methos if error counter is bitter than two. Next, a connected components
task.
