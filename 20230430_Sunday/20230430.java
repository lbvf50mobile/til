...
// = = = = = = = = = = = = = =
// Runtime: 11 ms, faster than 99.33% of Java online submissions for Remove Max
// Number of Edges to Keep Graph Fully Traversable.
// Memory Usage: 96.9 MB, less than 56.38% of Java online submissions for Remove
// Max Number of Edges to Keep Graph Fully Traversable.
// 2023.04.30 Daily Challenge.
class Solution {
    public int maxNumEdgesToRemove(int n, int[][] edges) {
        // Copied form the Leetcode's sotution.
