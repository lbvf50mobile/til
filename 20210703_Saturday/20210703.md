...
Well written solution with different appoaches and here open new data structure for Ruby/Python/Java Ordered Set, the structure that requred to make this task works.
